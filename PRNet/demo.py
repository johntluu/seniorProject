...
import argparse
import ast
from depthImageGenerator import generate_depth_image
...
from utils.write import write_obj_with_colors, write_obj_with_texture, write_obj_without_colors
    ...
    for i, image_path in enumerate(image_path_list):
        ...
        if args.is3d:
            ...
            if args.isTexture:
                ...
                write_obj_without_colors(os.path.join(save_folder, name + '.obj'), save_vertices, prn.triangles)
...
if __name__ == '__main__':
    ...
    # added
    parser.add_argument('--isColoured', default=True, type=ast.literal_eval,
                        help='whether to output the colour in the obj file')
