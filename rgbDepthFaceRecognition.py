...
rgbModel.compile(loss = 'sparse_categorical_crossentropy',
              optimizer = opt,
              metrics = ['categorical_accuracy'])
...
rgbHistory = rgbModel.fit(np.array(x_train), y_train,
                    batch_size = 2,
                    epochs = 200,
                    verbose = 0,
...
print(evaluation)
rgbEvaluation = rgbModel.evaluate(x = np.array(x_test), y = y_test, batch_size = 2)
print("Loss")
print(rgbHistory.history["loss"])
print("Val Loss")
print(rgbHistory.history["val_loss"])
print("Categorical Accuracy")
print(rgbHistory.history["categorical_accuracy"])
print("Val Categorical Accuracy")
print(rgbHistory.history["val_categorical_accuracy"])
print(rgbModel.metrics_names)
print(rgbEvaluation)
